...
export function WhenToTradeLessonContent() {
  return (
    <div className="space-y-6">
      ...
      <Card className="border border-[#5F0BE8]/20 bg-[#1a0f2e]/60 backdrop-blur-sm p-6 rounded-2xl">
        <h2 className="text-xl font-bold text-white mb-4">BINARY OPTIONS</h2>
        <p className="text-white/80 text-base leading-relaxed mb-4">
          The flexibility of binary options trading hours is a significant advantage, allowing you to access the market
          from anywhere in the world on weekdays.
        </p>
        <p className="text-white/80 text-base leading-relaxed mb-4">
      ...
      <Card className="border border-[#5F0BE8]/20 bg-[#1a0f2e]/60 backdrop-blur-sm p-6 rounded-2xl">
        ...
        <p className="text-white/80 text-base leading-relaxed">
          ...
          major events like Christmas or Prime-time TV events. It is also important to remember that major economic
      ...
      <Card className="border border-orange-500/30 bg-[#1a0f2e]/60 backdrop-blur-sm p-6 rounded-2xl">
        <h2 className="text-xl font-bold text-white mb-4">MIND YOUR EMOTIONAL STATE</h2>
        <p className="text-white/80 text-base leading-relaxed mb-4">
          ...
          impact your decision-making and lead to poor results.
        </p>
        <div className="bg-gradient-to-r from-orange-600/20 to-red-600/20 border border-orange-500/30 rounded-xl p-4">
          <p className="text-white/90 text-base font-medium">
            Therefore, it is essential to{" "}
            <strong className="text-orange-400">avoid trading when you are feeling emotional</strong>. Take a break,
            clear your mind, and return to trading when you're in a calm, focused state.
          </p>
        </div>
      </Card>
    </div>
