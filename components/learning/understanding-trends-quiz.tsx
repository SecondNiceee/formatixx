...
const questions: Question[] = [
  ...
  {
    id: 2,
    question: "What is the golden rule about trends?",
    options: [
      { label: "A", text: "Always predict trend reversals" },
      { label: "B", text: "The trend is your friend" },
      { label: "C", text: "Trends don't matter" },
    ],
    correctAnswer: "B",
  },
  {
    id: 3,
    question: "What characterizes a sideways trend?",
    options: [
      { label: "A", text: "Price moves between support and resistance" },
      { label: "B", text: "Consistent upward movement" },
      { label: "C", text: "Continuous downward pressure" },
    ],
    correctAnswer: "A",
  },
]
