            ...
            <div className="space-y-6 text-white/80">
              ...
              <section>
                ...
                <div className="bg-purple-600/10 border border-purple-600/30 rounded-lg p-4 space-y-3">
                  ...
                  <p className="font-mono text-sm">(Account Size × Risk %) / Stop Loss Distance = Position Size</p>
                  <p>
                    <strong>Example:</strong>
                  </p>
                  <p>Account: $10,000 | Risk: 1% ($100) | Stop Loss: 50 pips</p>
                  <p>$100 / 50 pips = $2 per pip</p>
                  <p>Trade 0.2 lots (mini lot where each pip = $1 × 2)</p>
                </div>
              </section>
              ...
              <section>
                ...
                <p className="mt-3 text-green-400">With a 1:2 ratio, you only need a 35% win rate to be profitable!</p>
              </section>
