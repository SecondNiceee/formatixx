...
const quizQuestions = [
  {
    question: "What does a 'Golden Cross' signal in the Moving Average Crossover strategy?",
    options: [
      "Fast MA crosses below Slow MA - sell signal",
      "Fast MA crosses above Slow MA - buy signal",
      "Both MAs are moving sideways",
      "RSI reaches 70",
    ],
    correctAnswer: 1,
    explanation:
      "A Golden Cross occurs when the fast MA (50) crosses above the slow MA (200), signaling a potential buy opportunity.",
  },
  {
    question: "What should be the minimum risk-reward ratio for this strategy?",
    options: ["1:1", "2:1 or 3:1", "5:1", "No specific ratio needed"],
    correctAnswer: 1,
    explanation:
      "A minimum risk-reward ratio of 2:1 or 3:1 helps ensure that your winning trades outweigh your losing trades over time.",
  },
  {
    question: "When should you enter a trade using this strategy?",
    options: [
      "Immediately when you see the crossover",
      "After waiting for candle close to confirm and entering on next candle open",
      "Only on Mondays",
      "When RSI is above 70",
    ],
    correctAnswer: 1,
    explanation:
      "Always wait for the candle to close to confirm the crossover signal, then enter on the next candle open to avoid false signals.",
  },
]
