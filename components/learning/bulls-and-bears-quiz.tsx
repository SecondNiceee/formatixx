...
const questions: Question[] = [
  {
    ...
    options: [
      { label: "A", text: "Falling prices and pessimism" },
      { label: "B", text: "Rising prices and investor confidence" },
      { label: "C", text: "Sideways price movement" },
    ],
    correctAnswer: "B",
  },
  {
    ...
    options: [
      { label: "A", text: "Sustained upward price movement" },
      { label: "B", text: "Market consolidation" },
      { label: "C", text: "Declining prices and investor pessimism" },
    ],
    correctAnswer: "C",
  },
  {
    id: 3,
    question: "What is the best strategy in a bull market?",
    options: [
      { label: "A", text: "Sell the rallies" },
      { label: "B", text: "Buy the dips" },
      { label: "C", text: "Avoid trading" },
    ],
    correctAnswer: "B",
  },
]
