          ...
          return (
            <button
              ...
              className={cn(
                ...
                // Selected state (before submit) - bright purple highlight with glow
                isSelected && !showResult && "border-purple-400 border-[3px] bg-purple-500/40 shadow-[0_0_20px_rgba(168,85,247,0.5)] scale-[1.02] ring-2 ring-purple-400/50",
            ...
            >
              <span
                className={cn(
                  ...
                  // Selected state (before submit) - bright purple with glow effect
                  isSelected && !showResult && "bg-purple-500 text-white scale-125 ring-4 ring-purple-400 shadow-[0_0_15px_rgba(168,85,247,0.8)]",
                  // After submit - correct answer
