...
const quizQuestions = [
  {
    question: "What is the first step in Top Down Trading analysis?",
    options: [
      "Analyze 5-minute charts for entry points",
      "Identify the overall trend on higher timeframes (weekly/daily)",
      "Set stop loss and take profit levels",
      "Execute trades immediately",
    ],
    correctAnswer: 1,
    explanation:
      "Top Down Trading always starts with higher timeframes to understand the big picture trend before moving to lower timeframes.",
  },
  {
    question: "What is the main benefit of using Top Down analysis?",
    options: [
      "It allows you to trade without stop losses",
      "You can trade against the major trend",
      "It helps you trade with the trend while timing entries precisely",
      "It eliminates all trading risks",
    ],
    correctAnswer: 2,
    explanation:
      "Top Down analysis helps you align with the major trend direction while using lower timeframes to find precise entry points.",
  },
  {
    question: "In the example where EUR/USD is in an uptrend on the weekly chart, what should you do?",
    options: [
      "Look for selling opportunities only",
      "Ignore the weekly trend and trade based on 1-hour chart",
      "Look for buying opportunities aligned with the uptrend",
      "Exit all positions immediately",
    ],
    correctAnswer: 2,
    explanation:
      "When the higher timeframe shows an uptrend, you should look for buying opportunities that align with that trend.",
  },
]
