...
const quizQuestions = [
  {
    ...
    options: [
      ...
      "Only buying euros",
      "Only selling dollars",
    ],
    correctAnswer: 1,
    explanation:
      "When you buy a currency pair, you're buying the base currency (EUR) and selling the quote currency (USD).",
  },
  {
    ...
    correctAnswer: 2,
    explanation: "A Market Order executes immediately at the current market price without any delays.",
  },
  {
    question: "If you believe GBP/USD will fall, what should you do?",
    options: ["Buy GBP/USD", "Sell GBP/USD", "Wait for it to rise first", "Do nothing"],
    correctAnswer: 1,
    explanation:
      "If you believe the pair will fall (base currency weakens), you should sell (go short) to profit from the decline.",
  },
]
