...
export const translations = {
  ...
  es: {
    ...
    common: {
      ...
      testYourKnowledge: "Prueba Tu Conocimiento",
      checkAnswer: "Verificar Respuesta",
      nextQuestion: "Siguiente Pregunta",
      completeLesson: "Completar Lección",
      nextLesson: "Siguiente:",
      wrongAnswer: "¡Oops, respuesta incorrecta!",
      wrongAnswerDesc: "Para completar esta lección debes responder correctamente las",
      questionsCorrectly: "preguntas.",
      restart: "Reiniciar",
  ...
  pt: {
    ...
    common: {
      ...
      yearsOld: "anos",
      calculate: "Calcular",
      backToLearning: "Voltar para Aprendizado",
      testYourKnowledge: "Teste Seu Conhecimento",
      checkAnswer: "Verificar Resposta",
      nextQuestion: "Próxima Pergunta",
      completeLesson: "Completar Lição",
      nextLesson: "Próximo:",
      wrongAnswer: "Oops, resposta errada!",
      wrongAnswerDesc: "Para completar esta lição você precisa responder corretamente as",
      questionsCorrectly: "perguntas.",
      restart: "Reiniciar",
  ...
  ar: {
    ...
    common: {
      ...
      nextLesson: "التالي:",
      wrongAnswer: "عذراً، إجابة خاطئة!",
      wrongAnswerDesc: "لإكمال هذا الدرس عليك الإجابة بشكل صحيح على جميع",
      questionsCorrectly: "الأسئلة.",
      restart: "إعادة تشغيل",
    ...
    analyze: {
      title: "تحليل التداول",
      uploadTitle: "رفع صورة الر��م البياني",
