...
const getLearningTopics = (t: any) => [
  ...
  {
    id: 4,
    title: t.learning.section4.title,
    subtitle: t.learning.section4.subtitle,
    icon: TrendingUp,
    lessons: [
      { title: t.learning.toolkit.volume, href: "/learning/volume-indicator" },
      { title: t.learning.toolkit.movingAverage, href: "/learning/moving-average" },
      { title: t.learning.toolkit.rsi, href: "/learning/rsi" },
    ],
  },
  {
    id: 5,
    title: t.learning.section5.title,
    subtitle: t.learning.section5.subtitle,
    icon: Trophy,
    lessons: [
      { title: t.learning.strategies.topDown, href: "/learning/top-down-trading" },
      { title: t.learning.strategies.example, href: "/learning/strategy-example" },
    ],
  },
  {
    id: 6,
    ...
    lessons: [
      ...
      { title: t.learning.execute.tradingStyle, href: "/learning/pick-trading-style" },
    ],
  },
  {
    id: 7,
    title: t.learning.section7.title,
    subtitle: t.learning.section7.subtitle,
    icon: Shield,
    lessons: [{ title: t.common.riskManagement || "Risk Management", href: "/learning/risk-management" }],
  },
  {
    id: 8,
    title: t.learning.section8.title,
    subtitle: t.learning.section8.subtitle,
    icon: BarChart3,
    lessons: [
      { title: t.common.smartPortfolios || "Smart Portfolios", href: "/learning/smart-portfolios" },
      { title: t.common.tradingCrypto || "Trading Cryptocurrencies", href: "/learning/trading-cryptocurrencies" },
      { title: t.common.realTrading || "Are You Ready For Real Trading?", href: "/learning/ready-for-real-trading" },
      { title: t.common.simToReal || "From Sim", href: "/learning/from-sim" },
    ],
  },
]
