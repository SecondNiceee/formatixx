...
import { GoldLessonContent } from "@/components/learning/gold-lesson-content"
import { GoldQuiz } from "@/components/learning/gold-quiz"
import Link from "next/link"

export default function GoldAndBinaryOptionsPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <Card className="border-2 border-[#5F0BE8]/50 bg-[#1a0f2e]/40 backdrop-blur-xl shadow-[0_0_40px_rgba(95,11,232,0.3)] p-6 sm:p-10 rounded-3xl sm:rounded-[2.5rem] mb-8">
            <div className="flex flex-col items-center justify-center text-center">
              <div className="w-16 h-16 rounded-full bg-yellow-600/20 flex items-center justify-center mb-4">
                <BookOpen className="w-8 h-8 text-yellow-500" />
              </div>
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Gold Prices and Binary Options</h1>
