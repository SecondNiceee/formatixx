...
import { SmartPortfoliosLessonContent } from "@/components/learning/smart-portfolios-lesson-content"
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <Card className="border-2 border-[#5F0BE8]/50 bg-[#1a0f2e]/40 backdrop-blur-xl shadow-[0_0_40px_rgba(95,11,232,0.3)] p-6 sm:p-10 rounded-3xl sm:rounded-[2.5rem] mb-8">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Smart Portfolios</h1>
              <p className="text-white/60 text-sm">Building a diversified trading portfolio</p>
            </div>
          </Card>

          <SmartPortfoliosLessonContent />
